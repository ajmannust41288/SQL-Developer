...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `calculate_pointer` (IN `roll_num` INT, IN `date` INT, OUT `pointer` INT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `insert_marks` (IN `s_id` INT, IN `s_roll_num` INT, IN `m` INT)  BEGIN
...
(1, 'ajmal', 'khan', 1, '0332-41182'),
(2, 'ajmal', 'khan', 1, '0332-41182'),
(3, 'ajmal', 'khan', 1, '0332-41182'),
(4, 'ajmal', 'khan', 1, '0332-41182'),
(5, 'ajmal', 'khan', 3, '0332-41182'),
(6, 'ajmal', 'khan', 3, '0332-41182');
...
(180101, 'Shivam', 'Rajput', 1, '7415487529', '2017-08-21', 141),
...
--
ALTER TABLE `students`
  MODIFY `roll_num` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=180105;
